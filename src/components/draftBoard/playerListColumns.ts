...
export type ColumnKey = "injury" | "adp" | "rank" | "bye" | "rookie" | "team" | "tier" | "value" | "draftedBy";
...
export const DEFAULT_COLUMN_ORDER: ColumnKey[] = ["injury", "adp", "rank", "bye", "rookie", "team", "tier", "value", "draftedBy"];
