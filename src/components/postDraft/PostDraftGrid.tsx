  ...
  return (
    <div className="card overflow-x-auto">
      <table className="border-collapse w-full min-w-max text-sm">
        <thead>
          <tr>
            <th className="sticky left-0 bg-surface-raised px-3 py-2 text-left text-xs font-semibold text-text-secondary border-b border-r border-border">
              Rd
            </th>
        ...
        <tbody>
          {grid.grid.map((row, roundIdx) => (
            <tr key={roundIdx}>
              <td className="sticky left-0 bg-surface-raised px-3 py-2 text-xs font-semibold text-text-secondary border-r border-b border-border">
                {roundIdx + 1}
              </td>
              {row.map((cell, teamIdx) => (
                <td
                  key={teamIdx}
                  className={[
                    "px-3 py-2 border-b border-border align-top whitespace-nowrap",
